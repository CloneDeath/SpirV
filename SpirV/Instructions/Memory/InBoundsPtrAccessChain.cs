...
{
	/// <summary>
	/// Has the same semantics as OpPtrAccessChain,
	/// with the addition that the resulting pointer is known to point within the base object.
	/// </summary>
	public class InBoundsPtrAccessChain : BaseInstruction
	{
		public InBoundsPtrAccessChain(int resultTypeId, int resultId, int baseId, int elementId, params int[] indexIds) {

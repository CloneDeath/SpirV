...
namespace SpirV.Instructions.Memory
{
	...
	/// </summary>
	public class InBoundsAccessChain : BaseInstruction
	{
		public InBoundsAccessChain(int resultTypeId, int resultId, int baseId, params int[] indexIds) {
		...
		public override Operation OpCode => Operation.InBoundsAccessChain;
